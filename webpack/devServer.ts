...
import { customConfig, hot, contourConfigFilePath } from './common';
...
if (Object.keys(localProxy).length > 0) {
	...
	proxyControllers = ProxyConfig.getProxyControllers(proxyConf, contourConfigFilePath, undefined, isHttps);
}
