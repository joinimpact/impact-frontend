...
export function findConversationOpportunity(opportunities: IOpportunityResponse[], conversationResponse: IConversationResponse): IOpportunityResponse | undefined {
