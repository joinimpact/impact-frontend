    ...
    return (
      <>
        <MediaQuery minWidth={1024}>
          <MediaContainer
            callback={this.props.changeLayout.bind(this, ILayoutType.desktop)}
          />
        </MediaQuery>
        <MediaQuery maxWidth={1023}>
          <MediaContainer
            callback={this.props.changeLayout.bind(this, ILayoutType.mobile)}
          />
        </MediaQuery>
      </>
    );
...
export default connect<void, IActionProps>(
  null,
  UIProvider.mapDispatch,
)(UIProvider);
