...
export type ISetUploadOpportunityLogoProgress = IAction<
'NPO_SERVICE:SET_UPLOAD_OPPORTUNITY_LOGO_PROGRESS',
number | null
>;
...
export type ILoadSingleOpportunitySuccess = IAction<
