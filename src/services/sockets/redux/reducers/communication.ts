...
export default combineReducers<NS.IReduxState['communications']>({
	connect: makeCommunicationReducer<NS.IConnect, NS.IConnectSuccess, NS.IConnectFailed>(
		'SOCKETS:CONNECT',
		'SOCKETS:CONNECT_SUCCESS',
		'SOCKETS:CONNECT_FAILED',
		initial.communications.connect,
	),
	reconnect: makeCommunicationReducer<NS.IReconnect, NS.IReconnectSuccess, NS.IReconnectFailed>(
		'SOCKETS:RECONNECT',
