...
} = makeCommunicationActionCreators<NS.ILoadSettings, NS.ILoadSettingsSuccess, NS.ILoadSettingsFailed>(
...
} = makeCommunicationActionCreators<NS.ILoadFullSettings, NS.ILoadFullSettingsSuccess, NS.ILoadFullSettingsFailed>(
...
} = makeCommunicationActionCreators<NS.IUpdateSettings, NS.IUpdateSettingsSuccess, NS.IUpdateSettingsFailed>(
