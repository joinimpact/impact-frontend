...
export default combineReducers<NS.IReduxState['communication']>({
	loadSettings: makeCommunicationReducer<NS.ILoadSettings, NS.ILoadSettingsSuccess, NS.ILoadSettingsFailed>(
	...
	updateSettings: makeCommunicationReducer<NS.IUpdateSettings, NS.IUpdateSettingsSuccess, NS.IUpdateSettingsFailed>(
