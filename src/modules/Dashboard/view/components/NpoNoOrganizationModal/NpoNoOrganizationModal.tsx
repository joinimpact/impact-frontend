...
class NpoNoOrganizationModal extends React.PureComponent<TProps> {
	public render() {
		...
		return (
			<Modal isOpen disablePadding onClose={this.props.onClose} title={t('NPO-NO-ORGANIZATION-MODAL:STATIC:TITLE')}>
				<div className={b()}>
					<div className={b('message')}>{t('NPO-NO-ORGANIZATION-MODAL:STATIC:BODY')}</div>
