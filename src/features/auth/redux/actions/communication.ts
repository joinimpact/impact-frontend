...
export const { execute: login, completed: loginSuccess, failed: loginFailed } = makeCommunicationActionCreators<
NS.ILogin,
NS.ILoginSuccess,
NS.ILoginFailed
>('AUTH:LOGIN', 'AUTH:LOGIN_SUCCESS', 'AUTH:LOGIN_FAILED');

export const {
	execute: recoveryPassword,
	completed: recoveryPasswordComplete,
	failed: recoveryPasswordFailed,
} = makeCommunicationActionCreators<NS.IRecoveryPassword, NS.IRecoveryPasswordSuccess, NS.IRecoveryPasswordFailed>(
...
} = makeCommunicationActionCreators<NS.IResetPassword, NS.IResetPasswordSuccess, NS.IResetPasswordFailed>(
	'AUTH:RESET_PASSWORD',
...
} = makeCommunicationActionCreators<NS.ICreateAccount, NS.ICreateAccountSuccess, NS.ICreateAccountFailed>(
	'AUTH:CREATE_ACCOUNT',
...
} = makeCommunicationActionCreators<NS.ICreatePassword, NS.ICreatePasswordSuccess, NS.ICreatePasswordFailed>(
...
>('AUTH:PUT_FACEBOOK_OAUTH_TOKEN', 'AUTH:PUT_FACEBOOK_OAUTH_TOKEN_SUCCESS', 'AUTH:PUT_FACEBOOK_OAUTH_TOKEN_FAILED');
...
>('AUTH:PUT_GOOGLE_OAUTH_TOKEN', 'AUTH:PUT_GOOGLE_OAUTH_TOKEN_SUCCESS', 'AUTH:PUT_GOOGLE_OAUTH_TOKEN_FAILED');

export const {
	execute: checkEmailFree,
	completed: checkEmailFreeComplete,
	failed: checkEmailFreeFailed,
} = makeCommunicationActionCreators<NS.ICheckEmailFree, NS.ICheckEmailFreeSuccess, NS.ICheckEmailFreeFailed>(
