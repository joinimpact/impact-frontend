...
class CreatePasswordForm extends React.PureComponent<TProps> {
				...
				<form onSubmit={this.handleCreatePassword} className={b('form')}>
					<div className={b('content')}>
						<div className={b('row')}>
							...
							<div className={b('field-caption')}>{t('CREATE-NEW-PASSWORD-FORM:LABEL:CREATE-PASSWORD')}</div>
							<div className={b('field-hint')}>{t('CREATE-NEW-PASSWORD-FORM:HINT:PASSWORD-COMPLEXITY')}</div>
						...
						<div className={b('row')}>
							<div className={b('asterisk')}>*</div>
							<div className={b('field-caption')}>{t('CREATE-NEW-PASSWORD-FORM:LABEL:CONFIRM-YOUR-PASSWORD')}</div>
							<div className={b('field-hint')}>{t('CREATE-NEW-PASSWORD-FORM:HINT:PASSWORD-REPEAT')}</div>
							<div className={b('field')}>
								<InputBaseFieldWrapper
									component={InputBaseField}
					...
					<div className={b('actions')}>
						<Button color="blue" disabled={invalid} isShowPreloader={communication.isRequesting}>
	...
	@bind
	private validatePasswordComplexity(value: string, allValues?: NS.ICreatePasswordForm, props?: TProps, name?: string) {
