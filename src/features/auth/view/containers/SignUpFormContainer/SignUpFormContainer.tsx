...
type TSignUpStep = 'select-user-type' | 'create-account' | 'create-password';
...
class SignUpFormContainer extends React.PureComponent<TProps, IState> {
	...
	public render() {
		return <div className={b()}>{this.renderCurrentStep()}</div>;
	}
	...
	private renderCurrentStep() {
		...
		switch (currentStep) {
			...
			case 'create-password':
				return (
					<CreatePasswordForm onCreatePassword={this.handleCreatePassword} communication={createAccountCommunication} />
				);
		}
