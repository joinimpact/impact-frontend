...
class AddVolunteerAreasOfInterest extends React.PureComponent<TProps, IState> {
	...
	public render() {
		...
		return (
			<div className={b()}>
				<div className={b('caption')}>{t('ADD-VOLUNTEER-AREAS-OF-INTEREST:STATIC:CAPTION')}</div>
				<div className={b('title')}>{t('ADD-VOLUNTEER-AREAS-OF-INTEREST:STATIC:TITLE')}</div>
				<div className={b('subtitle')}>{t('ADD-VOLUNTEER-AREAS-OF-INTEREST:STATIC:SUBTITLE')}</div>

				<div className={b('field')}>
					<Select isMulti selectedValue={this.props.userTags} options={this.tags} onSelect={this.handleSelectTag} />
				</div>
