...
class ApplyForOpportunityModal extends React.PureComponent<TProps> {
	public render() {
		...
		return (
			<Modal isOpen disablePadding title={t('APPLY-FOR-OPPORTUNITY-MODAL:STATIC:TITLE')} onClose={this.props.onClose}>
				<div className={b()}>
					<form onSubmit={this.handleSubmit}>
						<div className={b('content')}>
							<div className={b('subtitle')}>{t('APPLY-FOR-OPPORTUNITY-MODAL:STATIC:SUBTITLE')}</div>
