...
export default combineReducers<NS.IReduxState['communications']>({
	...
	loadUserEvents: makeCommunicationReducer<NS.ILoadUserEvents, NS.ILoadUserEventsSuccess, NS.ILoadUserEventsFailed>(
	...
	attendEvent: makeCommunicationReducer<NS.IAttendEvent, NS.IAttendEventSuccess, NS.IAttendEventFailed>(
		'VOLUNTEER:ATTEND_EVENT',
		'VOLUNTEER:ATTEND_EVENT_SUCCESS',
		'VOLUNTEER:ATTEND_EVENT_FAILED',
		initial.communications.attendEvent,
	),
	declineEvent: makeCommunicationReducer<NS.IDeclineEvent, NS.IDeclineEventSuccess, NS.IDeclineEventFailed>(
	...
	requestHours: makeCommunicationReducer<NS.IRequestHours, NS.IRequestHoursSuccess, NS.IRequestHoursFailed>(
		'VOLUNTEER:REQUEST_HOURS',
		'VOLUNTEER:REQUEST_HOURS_SUCCESS',
		'VOLUNTEER:REQUEST_HOURS_FAILED',
		initial.communications.requestHours,
	),
	deleteAccount: makeCommunicationReducer<NS.IDeleteAccount, NS.IDeleteAccountSuccess, NS.IDeleteAccountFailed>(
	...
	editUserProfile: makeCommunicationReducer<NS.IEditUserProfile, NS.IEditUserProfileSuccess, NS.IEditUserProfileFailed>(
