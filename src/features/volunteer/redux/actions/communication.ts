...
>('VOLUNTEER:BROWSE_OPPORTUNITIES', 'VOLUNTEER:BROWSE_OPPORTUNITIES_SUCCESS', 'VOLUNTEER:BROWSE_OPPORTUNITIES_FAILED');
...
} = makeCommunicationActionCreators<NS.ILoadUserEvents, NS.ILoadUserEventsSuccess, NS.ILoadUserEventsFailed>(
...
} = makeCommunicationActionCreators<NS.IAttendEvent, NS.IAttendEventSuccess, NS.IAttendEventFailed>(
...
} = makeCommunicationActionCreators<NS.IDeclineEvent, NS.IDeclineEventSuccess, NS.IDeclineEventFailed>(
...
} = makeCommunicationActionCreators<NS.IRequestHours, NS.IRequestHoursSuccess, NS.IRequestHoursFailed>(
...
} = makeCommunicationActionCreators<NS.IDeleteAccount, NS.IDeleteAccountSuccess, NS.IDeleteAccountFailed>(
...
} = makeCommunicationActionCreators<NS.IEditUserProfile, NS.IEditUserProfileSuccess, NS.IEditUserProfileFailed>(
