...
const hoursFrequencyOptions: ISimpleOptionValue<number>[] = [
...
class EditEventModal extends React.PureComponent<TProps> {
			...
			<div className={b('content')}>
				...
				<div className={b('block')}>
					<div className={b('row', { 'up-aligned': true })}>
						<div className={b('row-label')}>{t('CREATE-NEW-EVENT-MODAL:LABEL:DESCRIPTION')}</div>
					...
					<div className={b('row')}>
						<div className={b('row-label')}>{t('CREATE-NEW-EVENT-MODAL:LABEL:LOCATION')}</div>
						<div className={b('row-field')}>
							<CountryFieldWrapper
				...
				<div className={b('block')}>
					<div className={b('row')}>
						<div className={b('row-label')}>{t('CREATE-NEW-EVENT-MODAL:LABEL:OPPORTUNITY')}</div>
						<div className={b('row-field')}>
							<OpportunitySelectFieldWrapper
				...
				<div className={b('block')}>
					<div className={b('row', { 'with-checkbox': true })}>
						<div>{t('CREATE-NEW-EVENT-MODAL:LABEL:ALL-DAY')}</div>
						<div className={b('row-field')}>
							<CheckboxFieldWrapper component={CheckboxField} name={fieldNames.isAllDay} />
						</div>
					</div>

					<div className={b('row')}>
						<div className={b('row-label')}>{t('CREATE-NEW-EVENT-MODAL:LABEL:STARTING-DATE')}</div>
						<div className={b('row-field')}>
					...
					<div className={b('row')}>
						<div className={b('row-label')}>{t('CREATE-NEW-EVENT-MODAL:LABEL:ENDING-DATE')}</div>
						<div className={b('row-field')}>
							<DatePickerFieldWrapper
								noIcon
								withTime={!isAllDay}
					...
					<div className={b('row')}>
						<div className={b('row-label')}>{t('CREATE-NEW-EVENT-MODAL:LABEL:HOURS')}</div>
						<div className={b('row-field')}>
	...
	@bind
	private validateStartDate(value: string, allValues: NS.IEditEventForm, props: TProps, name: string) {
		const { translate: t } = this.props;
	...
	@bind
	private validateEndDate(value: string, allValues: NS.IEditEventForm, props: TProps, name: string) {
		const { translate: t } = this.props;
