...
type TCardId = 'org-name' | 'location' | 'website' | 'description';

const fields: TCardId[] = ['org-name', 'location', 'website', 'description'];
		...
		switch (id) {
			case 'org-name':
				return (
					...
					>
						<div className={b('card-body')}>{t('EDIT-ORGANIZATION-FORM:CARD:ORGANIZATION-NAME-BODY')}</div>
			...
			case 'location':
				return (
					...
					>
						<div className={b('card-body')}>{t('EDIT-ORGANIZATION-FORM:CARD:ADDRESS-BODY')}</div>
						<CountryFieldWrapper
			...
			case 'website':
				return (
					...
					>
						<div className={b('card-body')}>{t('EDIT-ORGANIZATION-FORM:CARD:WEBSITE-BODY')}</div>
			...
			case 'description':
				return (
					...
					>
						<div className={b('card-body')}>{t('EDIT-ORGANIZATION-FORM:CARD:DESCRIPTION-BODY')}</div>
