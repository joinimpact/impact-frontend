		...
		return (
			<div className={b()}>
				<div className={b('avatar')}>
					{organization.profilePicture && <Image className={b('avatar-image')} src={organization.profilePicture} />}
				</div>
				<div className={b('organization-name')}>{organization.name}</div>
				<div className={b('access-type-text')}>{t('ORGANIZATION-PORTFOLIO-AREA:STATIC:YOU-ARE-ADMIN')}</div>
