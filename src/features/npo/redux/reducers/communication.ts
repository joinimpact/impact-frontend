...
export default combineReducers<NS.IReduxState['communications']>({
	...
	uploadOrgLogo: makeCommunicationReducer<NS.IUploadOrgLogo, NS.IUploadOrgLogoSuccess, NS.IUploadOrgLogoFailed>(
		'NPO:UPLOAD_ORG_LOGO',
	...
	editEvent: makeCommunicationReducer<NS.IEditEvent, NS.IEditEventSuccess, NS.IEditEventFailed, NS.IEditEventReset>(
		'NPO:EDIT_EVENT',
	...
	deleteEvent: makeCommunicationReducer<NS.IDeleteEvent, NS.IDeleteEventSuccess, NS.IDeleteEventFailed>(
		'NPO:DELETE_EVENT',
	...
	acceptHours: makeCommunicationReducer<NS.IAcceptHours, NS.IAcceptHoursSuccess, NS.IAcceptHoursFailed>(
		'NPO:ACCEPT_HOURS',
		'NPO:ACCEPT_HOURS_SUCCESS',
		'NPO:ACCEPT_HOURS_FAILED',
		initial.communications.acceptHours,
	),
	declineHours: makeCommunicationReducer<NS.IDeclineHours, NS.IDeclineHoursSuccess, NS.IDeclineHoursFailed>(
		'NPO:DECLINE_HOURS',
