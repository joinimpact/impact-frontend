...
} = makeCommunicationActionCreators<NS.IUploadOrgLogo, NS.IUploadOrgLogoSuccess, NS.IUploadOrgLogoFailed>(
	'NPO:UPLOAD_ORG_LOGO',
...
>('NPO:REQUEST_NEW_OPPORTUNITY_ID', 'NPO:REQUEST_NEW_OPPORTUNITY_ID_SUCCESS', 'NPO:REQUEST_NEW_OPPORTUNITY_ID_FAILED');
...
>('NPO:UPLOAD_OPPORTUNITY_LOGO', 'NPO:UPLOAD_OPPORTUNITY_LOGO_SUCCESS', 'NPO:UPLOAD_OPPORTUNITY_LOGO_FAILED');
...
>('NPO:LOAD_SINGLE_OPPORTUNITY', 'NPO:LOAD_SINGLE_OPPORTUNITY_SUCCESS', 'NPO:LOAD_SINGLE_OPPORTUNITY_FAILED');

export const {
	execute: deleteOpportunity,
	completed: deleteOpportunityComplete,
	failed: deleteOpportunityFailed,
} = makeCommunicationActionCreators<NS.IDeleteOpportunity, NS.IDeleteOpportunitySuccess, NS.IDeleteOpportunityFailed>(
...
>('NPO:PUBLISH_OPPORTUNITY', 'NPO:PUBLISH_OPPORTUNITY_SUCCESS', 'NPO:PUBLISH_OPPORTUNITY_FAILED');
...
>('NPO:UNPUBLISH_OPPORTUNITY', 'NPO:UNPUBLISH_OPPORTUNITY_SUCCESS', 'NPO:UNPUBLISH_OPPORTUNITY_FAILED');
...
} = makeCommunicationActionCreators<NS.IAcceptInvitation, NS.IAcceptInvitationSuccess, NS.IAcceptInvitationFailed>(
...
} = makeCommunicationActionCreators<NS.IDeclineInvitation, NS.IDeclineInvitationSuccess, NS.IDeclineInvitationFailed>(
...
} = makeCommunicationActionCreators<NS.IEditEvent, NS.IEditEventSuccess, NS.IEditEventFailed, NS.IEditEventReset>(
	'NPO:EDIT_EVENT',
...
} = makeCommunicationActionCreators<NS.IDeleteEvent, NS.IDeleteEventSuccess, NS.IDeleteEventFailed>(
	'NPO:DELETE_EVENT',
...
>('NPO:SET_CURRENT_CONVERSATION', 'NPO:SET_CURRENT_CONVERSATION_SUCCESS', 'NPO:SET_CURRENT_CONVERSATION_FAILED');
...
} = makeCommunicationActionCreators<NS.IAcceptHours, NS.IAcceptHoursSuccess, NS.IAcceptHoursFailed>(
	'NPO:ACCEPT_HOURS',
...
} = makeCommunicationActionCreators<NS.IDeclineHours, NS.IDeclineHoursSuccess, NS.IDeclineHoursFailed>(
	'NPO:DECLINE_HOURS',
