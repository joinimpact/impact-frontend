...
class NotifyMessage extends React.PureComponent<TProps> {
	...
	private renderContent() {
		...
		switch (message.type) {
			...
			case 'ERROR':
				return <NotifyTypeMessage text={message.body as string} icon={'error'} />;
			case 'WARN':
				return <NotifyTypeMessage text={message.body as string} icon={'warn'} />;
			case 'INFO':
				return <NotifyTypeMessage text={message.body as string} icon={'info'} />;
		}
